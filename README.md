...
### Set link to legal notice

There is already a link to the legal notice included in the footer. All you need to do is setting the correct path in [footer.component.html](src/main/webapp/app/layouts/footer/footer.component.html)

### Set logo

Simply replace [logo.png](src/main/webapp/content/images/icon.png) with your own logo. For some more style settings for the logo have a look at the .logo-img section at [navbar.scss](src/main/webapp/app/layouts/navbar/navbar.scss).

## Building for production

### Packaging as jar

To build the final jar and optimize the FahrschuleASA application for production, run:
